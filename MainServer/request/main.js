...
module.exports = async(client, msg, args, prefix, message) => {
    ...
    if (msg.startsWith(prefix + "report")) {
        const commandFile = require(`./report.js`);
        commandFile(client, msg, args, prefix, message)
    }
    else if (msg.startsWith(prefix + "question")) {
        const commandFile = require(`./questions/question.js`);
        commandFile(client, msg, args, prefix, message)
    }
    else if (msg.startsWith(prefix + "botrequest")) {
        const commandFile = require(`./botRequest.js`);
        commandFile(client, msg, args, prefix, message)
    }
}