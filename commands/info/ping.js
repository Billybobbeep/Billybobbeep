module.exports = {
    ...
    async execute (message, prefix, client) {
        ...
        await client.channels.fetch('775402441021456385').send(`Ping, Receiving data for: **${message.guild.name}** (${message.guild.id})`).then(msg => serverResponse = msg.createdAt - message.createdAt);
