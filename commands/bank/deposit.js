module.exports = {
    ...
    execute (message, prefix, client) {
        ...
        if (args[1] !== 'a' || args[1] !== 'all') {
            ...
            if (db.get(message.author.id + '.economy.balance') < amt) return message.channel.send(`You do not have **${amt}** in your wallet.`);
            ...
            db.subtract(message.author.id + '.economy.balance', db.get(message.author.id + '.economy.balance'));
            message.channel.send(`Successfully deposited **${amt}**.`);
        }
    }
}